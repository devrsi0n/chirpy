...
function comment() {
  ...
  fetch("".concat("http://localhost:3000", "/api/get-page-by-project?projectId=").concat(pid, "&url=").concat(window.location.origin, "&title=").concat(window.document.title)).then(function (res) {
    return res.json();
  }).then(function (page) {
    if (!page) {
    ...
    container.src = "".concat("http://localhost:3000", "/widget/").concat(pid, "/").concat(page.id);
    container.id = id;
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","comment.ts"], null)
