...
export type PageByUrlQuery = { __typename?: 'query_root' } & {
  pages: Array<{ __typename?: 'Page' } & Pick<Types.Page, 'id' | 'url' | 'title'>>;
};
...
export type InsertOnePageMutation = { __typename?: 'mutation_root' } & {
  insertOnePage?: Types.Maybe<{ __typename?: 'Page' } & Pick<Types.Page, 'id' | 'url' | 'title'>>;
};

export type PagesQueryVariables = Types.Exact<{ [key: string]: never }>;

export type PagesQuery = { __typename?: 'query_root' } & {
  pages: Array<{ __typename?: 'Page' } & Pick<Types.Page, 'id'>>;
};
...
export const InsertOnePageDocument: DocumentNode<
...
export const PagesDocument: DocumentNode<PagesQuery, PagesQueryVariables> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
