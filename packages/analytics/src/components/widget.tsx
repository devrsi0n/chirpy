...
function WidgetWarning({ children }: { children: ReactNode }) {
  return (
    <div className="absolute inset-x-0 bottom-0 flex items-center justify-center gap-2 bg-yellow-200 p-8">
      <div>
        <svg
          width="16"
          height="16"
