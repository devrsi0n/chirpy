...
- Docker v20.10.18+ & Docker Compose v1.27.4+, follow [this docs](https://docs.docker.com/desktop/install/linux-install/) to install
- Nodejs v16.17.1+, npm v6+, follow the [nvm](https://github.com/nvm-sh/nvm#install--update-script) doc to install
