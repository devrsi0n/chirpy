    ...
    <article sx={{ display: 'flex', gap: 4, flexDirection: 'column' }}>
      ...
      <Box>
        ...
        <Text>
          ...
          materials on any other server. This license shall automatically terminate if you violate
          any of these restrictions and may be terminated by ZOO at any time. Upon terminating your
      ...
      <Box>
        ...
        <Text>
          ...
          website at any time without notice. However ZOO does not make any commitment to update the
          materials.
        </Text>
      </Box>
      <Box>
      ...
      <Box>
        ...
        <Text>
          ZOO has not reviewed all of the sites linked to its website and is not responsible for the
          contents of any such linked site. The inclusion of any link does not imply endorsement by
          ZOO of the site. Use of any such linked website is at the user’s own risk.
        </Text>
      </Box>
      <Box>
        <Heading as="h2">7. Modifications</Heading>
        <Text>
          ZOO may revise these terms of service for its website at any time without notice. By using
