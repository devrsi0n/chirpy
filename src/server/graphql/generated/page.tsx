...
export type UpdatePagesMutation = { __typename?: 'mutation_root', updatePages?: { __typename?: 'Page_mutation_response', affected_rows: number, returning: Array<{ __typename?: 'Page', id: string }> } | null | undefined };

export type PagesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type PagesQuery = { __typename?: 'query_root', pages: Array<{ __typename?: 'Page', id: string, url: string }> };
...
export type PageByUrlOnlyQuery = { __typename?: 'query_root', pages: Array<{ __typename?: 'Page', id: string, url: string }> };
