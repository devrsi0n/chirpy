...
export type ProjectAnalyticsQuery = { __typename?: 'query_root', projectByPk?: { __typename?: 'Project', id: string, name: string, domain: string, createdAt: string } | null | undefined };
